  ...
  return (
    <section className="seo-content" aria-label="Service areas and specialties">
      <div className="container">
        ...
        <h3>Service Areas</h3>
        <p>Loveland, Fort Collins, Greeley, Longmont, Windsor, Johnstown, Milliken, Timnath, Wellington, Berthoud, Estes Park, and Evans. For the right project, we are willing to serve all of Colorado.</p>
      </div>
    </section>
  );
}
