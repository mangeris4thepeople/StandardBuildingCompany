  ...
  return (
    <section className="seo-content" aria-label="Service areas and specialties">
      <div className="container">
        ...
        <p>We specialize in commercial tenant finish and tenant improvement projects for office, retail, medical, and restaurant spaces throughout Loveland, Fort Collins, Greeley, and Longmont, Colorado.</p>
        <h3>Steel Erection and Structural Steel Contractor — Northern Colorado</h3>
        <p>Standard Building Company provides structural steel erection, pre-engineered metal building installation, light gauge steel framing, metal decking, and miscellaneous metals for commercial and industrial projects across Northern Colorado and the Colorado Front Range.</p>
        <h3>Government and Public Works Contractor — Colorado</h3>
        <p>SBC is experienced in prevailing wage, Davis-Bacon, and public procurement requirements for municipal, county, and federal construction projects. We serve government agencies across Northern Colorado with full compliance documentation and reporting.</p>
        <h3>Industrial Construction Contractor — Northern Colorado</h3>
        <p>We build warehouses, manufacturing facilities, distribution centers, and heavy commercial projects throughout Northern Colorado. Our industrial construction capabilities include concrete tilt-up, steel erection, mechanical and electrical systems, and full site development.</p>
        <h3>Service Areas</h3>
        <p>Standard Building Company serves the entire Northern Colorado region including Loveland, Fort Collins, Greeley, Longmont, Windsor, Johnstown, Milliken, Timnath, Wellington, Berthoud, Estes Park, Evans, and surrounding Front Range communities.</p>
      </div>
    </section>
  );
}
