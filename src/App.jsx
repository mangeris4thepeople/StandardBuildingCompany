...
const SERVICES = [
  ...
  { title: 'Demolition & Existing Conditions', description: 'Selective demolition, commercial demolition, hazardous material abatement, asbestos abatement, lead paint abatement, and environmental remediation.' },
  { title: 'Thermal & Moisture Protection', description: 'Building envelope systems including spray foam insulation, batt insulation, rigid insulation, air barrier, vapor barrier, firestopping, and joint sealants.' },
  { title: 'Specialties', description: 'Toilet partitions, restroom accessories, fire extinguishers, operable partitions, lockers, commercial signage, ADA signage, corner guards, and demountable partitions.' },
  { title: 'Equipment', description: 'Commercial kitchen equipment, loading dock equipment, waste compactors, food service equipment, hydraulic dock levelers, and vehicle service equipment.' },
  { title: 'Furnishings', description: 'Commercial furniture installation, window treatments, blinds, manufactured seating, systems furniture, modular furniture, and auditorium seating.' },
  { title: 'Special Construction', description: 'Pre-engineered metal buildings, modular buildings, clean rooms, radiation shielding, sound isolation rooms, aquatic facilities, and solar energy systems.' },
  { title: 'Conveying Equipment', description: 'Commercial elevator installation, wheelchair lifts, dumbwaiters, material lifts, vertical platform lifts, stair lifts, and freight elevators.' },
  { title: 'Integrated Automation', description: 'Building automation systems, smart building controls, energy management systems, automated lighting, HVAC automation, and building management system integration.' },
  { title: 'Exterior Improvements', description: 'Asphalt paving, parking lots, curb and gutter, sidewalks, retaining walls, fencing, site furnishings, bollards, exterior lighting, and pavement marking.' },
];

const WHY_REASONS = [
  { num: '01', title: 'Women & Minority Owned', body: 'Standard Building Company is a certified Women and Minority Owned Business (WMBE). For clients with diversity spend requirements on government, institutional, or corporate projects, SBC helps you meet those goals without sacrificing quality or capability. We bring the same credentials to the table that large firms charge a premium for.' },
  { num: '02', title: 'Local. Present. Accountable.', body: 'We are based in Loveland and we work in Northern Colorado. That means the person you call is the person on site. No regional offices, no account managers passing messages. When you need answers, you get them from someone who was at your project that morning.' },
  { num: '03', title: 'Hands-On at Every Phase', body: 'SBC leadership is not a management-only operation. We are in the field, reviewing submittals, walking the site, and solving problems in real time. The level of attention you get from us is not something you will find at a larger firm where your project is one of fifty.' },
  { num: '04', title: 'We Consult. We Contract. We Do Both.', body: 'Most contractors show up when there is a contract to sign. We show up earlier. SBC offers pre-construction consulting, owner representation, and feasibility analysis before the first dollar is committed. If you need a contractor in the field and an advisor at the table, that is exactly what we provide.' },
  { num: '05', title: 'Built for Commercial, Industrial & Government Work', body: 'We are not a residential remodeler who also does commercial work. SBC is purpose-built for commercial, industrial, institutional, and government construction. We understand prevailing wage, Davis-Bacon compliance, public procurement, and the documentation requirements that come with complex projects.' },
];
  ...
  return (
    <nav className={`nav${scrolled ? ' nav--scrolled' : ''}`}>
      <Link to="/" className="nav__logo" onClick={() => setMenuOpen(false)}>
        <svg className="nav__logo-img" viewBox="0 0 100 90" xmlns="http://www.w3.org/2000/svg">
          <polygon points="50,5 95,85 5,85" fill="#C9A96E"/>
          <rect x="43" y="38" width="7" height="47" fill="#1a1208"/>
          <rect x="52" y="28" width="7" height="57" fill="#1a1208"/>
          <rect x="61" y="44" width="6" height="41" fill="#1a1208"/>
          <rect x="34" y="50" width="6" height="35" fill="#1a1208"/>
          <rect x="68" y="54" width="5" height="31" fill="#1a1208"/>
          <rect x="5" y="82" width="90" height="4" rx="1" fill="#A07540"/>
        </svg>
      ...
      <ul className={`nav__links${menuOpen ? ' nav__links--open' : ''}`}>
        {links.map(l => (
          <li key={l.to}>
            <Link to={l.to} className={location.pathname === l.to ? 'nav__link--active' : ''} onClick={() => setMenuOpen(false)}>{l.label}</Link>
          </li>
        ))}
        <li><a href="tel:9704305884" className="nav__cta">(970) 430-5884</a></li>
      </ul>
    </nav>
  );
}
      ...
      <section className="home-intro">
        <div className="container">
          ...
          <div className="home-stats">
            ...
            <div className="home-stat__div" />
            <div className="home-stat">
              <span className="home-stat__num">Colorado</span>
        ...
        <div className="container">
          <div className="about__inner">
            ...
            <div className="about__content">
              ...
              <p className="about__body"><strong>Standard Building Company is a Women and Minority Owned general contractor founded in 2020 and based in Loveland, Colorado.</strong> We serve residential, commercial, industrial, institutional, and government clients across Northern Colorado including Fort Collins, Greeley, Longmont, Windsor, and the surrounding Front Range.</p>
              <p className="about__body"><strong>What sets us apart is the depth of what we offer — we don't just manage projects, we consult.</strong> From early-stage pre-construction planning, budgeting, and feasibility through full construction delivery across all CSI divisions, our team brings hands-on expertise to every phase. Whether you need an owner's representative at the table or a licensed general contractor in the field, SBC does both.</p>
              <p className="about__body"><strong>We built this company on the belief that great construction starts long before the first pour.</strong> Every decision made in pre-construction saves time and money in the field. That philosophy drives everything we do.</p>
...
function Services() {
  ...
  return (
    <>
      <PageHero eyebrow="What We Do" title="OUR SERVICES" subtitle="Full-scope construction services across all CSI divisions." />
      <section className="interior-section" id="services">
        <div className="container">
          <div className="accordion">
            {SERVICES.map((s, i) => (
              <div className={`accordion__item${open === i ? ' accordion__item--open' : ''}`} key={s.title}>
...
function SEOContent() {
  return (
    <section className="seo-content" aria-label="Service areas and specialties">
      <div className="container">
        <h2>Colorado General Contractor</h2>
        <p>Standard Building Company provides full-service general contracting, construction management, design-build, and pre-construction consulting to residential, commercial, industrial, institutional, and government clients across Northern Colorado. As a Women and Minority Owned (WMBE) contractor based in Loveland, CO, we self-perform and manage work spanning all CSI construction divisions.</p>
        <h3>Service Areas</h3>
        <p>Loveland, Fort Collins, Greeley, Longmont, Windsor, Johnstown, Milliken, Timnath, Wellington, Berthoud, Estes Park, and Evans. We are willing to work in any municipality in Colorado for the right size project.</p>
      </div>
    </section>
  );
}
