        ...
        <div className="container">
          <div className="about__inner">
            ...
            <div className="about__content">
              ...
              <p className="about__body"><strong>Standard Building Company is a Women and Minority Owned general contractor</strong> founded in 2020 and based in Loveland, Colorado. We serve residential, commercial, industrial, institutional, and government clients across Northern Colorado including Fort Collins, Greeley, Longmont, Windsor, and the surrounding Front Range.</p>
